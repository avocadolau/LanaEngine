...
namespace Lanna
{
	...
	void GameObject::Render() {
		...
		if (m_Mesh)
			Lanna::Application::Get().GetRenderer().RenderMesh(m_Mesh, m_Transform->m_Position, m_Transform->m_Rotation, m_Transform->m_Scale, m_Material, glm::vec4(1.0f, 1.0f, 1.0f, 1.0f));
	}
